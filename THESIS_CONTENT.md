...
The following references are cited in this thesis in accordance with the APA (7th edition) citation style. Entries are listed alphabetically by the first author's surname.
...
8. Cheok, M. J., Omar, Z., & Jaward, M. H. (2019). A review of hand gesture and sign language recognition techniques. *International Journal of Machine Learning and Cybernetics*, 10(1), 131–153. https://doi.org/10.1007/s13042-017-0705-5

9. Cooper, H., Holt, B., & Bowden, R. (2011). Sign language recognition. In T. B. Moeslund, A. Hilton, V. Krüger, & L. Sigal (Eds.), *Visual analysis of humans* (pp. 539–562). Springer. https://doi.org/10.1007/978-0-85729-997-0_27

10. Cortes, C., & Vapnik, V. (1995). Support-vector networks. *Machine Learning*, 20(3), 273–297. https://doi.org/10.1007/BF00994018

11. Dipietro, L., Sabatini, A. M., & Dario, P. (2008). A survey of glove-based systems and their applications. *IEEE Transactions on Systems, Man, and Cybernetics, Part C (Applications and Reviews)*, 38(4), 461–482. https://doi.org/10.1109/TSMCC.2008.923862

12. Er-Rady, A., Faizi, R., Thami, R. O. H., & Housni, H. (2017). Automatic sign language recognition: A survey. *Proceedings of the International Conference on Advanced Technologies for Signal and Image Processing (ATSIP)*, 1–7. https://doi.org/10.1109/ATSIP.2017.8075561
...
14. Koller, O., Forster, J., & Ney, H. (2015). Continuous sign language recognition: Towards large vocabulary statistical recognition systems handling multiple signers. *Computer Vision and Image Understanding*, 141, 108–125. https://doi.org/10.1016/j.cviu.2015.09.013

15. Kudrinko, K., Flavin, E., Zhu, X., & Li, Q. (2020). Wearable sensor-based sign language recognition: A comprehensive review. *IEEE Reviews in Biomedical Engineering*, 14, 82–97. https://doi.org/10.1109/RBME.2020.3019769

16. LeCun, Y., Bengio, Y., & Hinton, G. (2015). Deep learning. *Nature*, 521(7553), 436–444. https://doi.org/10.1038/nature14539

17. Mujahid, A., Awan, M. J., Yasin, A., Mohammed, M. A., Damaševičius, R., Maskeliūnas, R., & Abdulkareem, K. H. (2021). Real-time hand gesture recognition based on deep learning YOLOv3 model. *Applied Sciences*, 11(9), 4164. https://doi.org/10.3390/app11094164
...
19. Rastgoo, R., Kiani, K., & Escalera, S. (2021). Sign language recognition: A deep survey. *Expert Systems with Applications*, 164, 113794. https://doi.org/10.1016/j.eswa.2020.113794
...
21. Wadhawan, A., & Kumar, P. (2021). Sign language recognition systems: A decade systematic literature review. *Archives of Computational Methods in Engineering*, 28(3), 785–813. https://doi.org/10.1007/s11831-019-09384-2

### Conference Proceedings

22. Chai, X., Li, G., Lin, Y., Xu, Z., Tang, Y., Chen, X., & Zhou, M. (2013). Sign language recognition and translation with Kinect. *10th IEEE International Conference on Automatic Face and Gesture Recognition (FG)*, 1–6.

23. Cui, R., Liu, H., & Zhang, C. (2017). Recurrent convolutional neural networks for continuous sign language recognition by staged optimization. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR)*, 7361–7369. https://doi.org/10.1109/CVPR.2017.175

24. Huang, J., Zhou, W., Li, H., & Li, W. (2015). Sign language recognition using 3D convolutional neural networks. *IEEE International Conference on Multimedia and Expo (ICME)*, 1–6. https://doi.org/10.1109/ICME.2015.7177428

25. Kohavi, R. (1995). A study of cross-validation and bootstrap for accuracy estimation and model selection. *Proceedings of the 14th International Joint Conference on Artificial Intelligence (IJCAI)*, 2, 1137–1143.

26. Li, D., Rodriguez, C., Yu, X., & Li, H. (2020). Word-level deep sign language recognition from video: A new large-scale dataset and methods comparison. *IEEE Winter Conference on Applications of Computer Vision (WACV)*, 1459–1469. https://doi.org/10.1109/WACV45572.2020.9093512

27. Molchanov, P., Yang, X., Gupta, S., Kim, K., Tyree, S., & Kautz, J. (2016). Online detection and classification of dynamic hand gestures with recurrent 3D convolutional neural networks. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR)*, 4207–4215. https://doi.org/10.1109/CVPR.2016.456

28. Pigou, L., Dieleman, S., Kindermans, P.-J., & Schrauwen, B. (2015). Sign language recognition using convolutional neural networks. *European Conference on Computer Vision (ECCV) Workshops*, 572–578. https://doi.org/10.1007/978-3-319-16178-5_40

29. Simonyan, K., & Zisserman, A. (2014). Two-stream convolutional networks for action recognition in videos. *Advances in Neural Information Processing Systems (NeurIPS)*, 27, 568–576.

30. Vaswani, A., Shazeer, N., Parmar, N., Uszkoreit, J., Jones, L., Gomez, A. N., Kaiser, Ł., & Polosukhin, I. (2017). Attention is all you need. *Advances in Neural Information Processing Systems (NeurIPS)*, 30, 5998–6008.

31. Zafrulla, Z., Brashear, H., Starner, T., Hamilton, H., & Presti, P. (2011). American Sign Language recognition with the Kinect. *Proceedings of the 13th ACM International Conference on Multimodal Interfaces (ICMI)*, 279–286. https://doi.org/10.1145/2070481.2070532

### Technical Reports and Preprints

32. Bazarevsky, V., Kartynnik, Y., Vakunov, A., Raveendran, K., & Grundmann, M. (2019). BlazeFace: Sub-millisecond neural face detection on mobile GPUs. *arXiv preprint arXiv:1907.05047*. https://arxiv.org/abs/1907.05047

33. Lugaresi, C., Tang, J., Nash, H., McClanahan, C., Uboweja, E., Hays, M., Zhang, F., Chang, C.-L., Yong, M. G., Lee, J., Chang, W.-T., Hua, W., Georg, M., & Grundmann, M. (2019). MediaPipe: A framework for building perception pipelines. *arXiv preprint arXiv:1906.08172*. https://arxiv.org/abs/1906.08172

34. Zhang, F., Bazarevsky, V., Vakunov, A., Tkachenka, A., Sung, G., Chang, C.-L., & Grundmann, M. (2020). MediaPipe Hands: On-device real-time hand tracking. *arXiv preprint arXiv:2006.10214*. https://arxiv.org/abs/2006.10214

### Software, Frameworks, and Documentation

35. Google LLC. (2023). *MediaPipe: Cross-platform, customizable ML solutions for live and streaming media*. https://mediapipe.dev
...
37. Hunter, J. D. (2007). Matplotlib: A 2D graphics environment. *Computing in Science & Engineering*, 9(3), 90–95. https://doi.org/10.1109/MCSE.2007.55

38. OpenCV Team. (2024). *OpenCV: Open source computer vision library (Version 4.10.0)* [Computer software]. https://opencv.org

39. Python Software Foundation. (2024). *Python language reference (Version 3.11)*. https://docs.python.org/3.11/

40. SQLAlchemy Authors. (2024). *SQLAlchemy: The Python SQL toolkit and Object Relational Mapper (Version 2.0)* [Computer software]. https://www.sqlalchemy.org

41. Waskom, M. L. (2021). seaborn: Statistical data visualization. *Journal of Open Source Software*, 6(60), 3021. https://doi.org/10.21105/joss.03021

### Datasets and Standards

42. Li, D., Rodriguez, C., Yu, X., & Li, H. (2020). *WLASL: Word-Level American Sign Language dataset* [Dataset]. https://dxli94.github.io/WLASL/

43. Sehyr, Z. S., Caselli, N., Cohen-Goldberg, A. M., & Emmorey, K. (2021). The ASL-LEX 2.0 project: A database of lexical and phonological properties for 2,723 signs in American Sign Language. *The Journal of Deaf Studies and Deaf Education*, 26(2), 263–277. https://doi.org/10.1093/deafed/enaa038

### Web Sources and Reports

44. Dreyer, K., & Malik, M. (2023). *Text-to-speech synthesis technologies: A review*. Speech Technology Magazine. https://www.speechtechmag.com

45. Stack Overflow. (2024). *2024 Developer Survey: Technology trends*. https://survey.stackoverflow.co/2024/

46. World Federation of the Deaf. (2023). *Our work: Human rights of deaf people*. https://wfdeaf.org/our-work/

47. World Health Organization. (2024). *Deafness and hearing loss* [Fact sheet]. https://www.who.int/news-room/fact-sheets/detail/deafness-and-hearing-loss

---

## APPENDIX A: BIOGRAPHY OF THE AUTHORS

This section presents a brief biography of the three authors who jointly designed, implemented, and evaluated the *Sign Language AI Translator (SLAT)* as part of their undergraduate thesis at Jahangirnagar University, along with the academic supervisor who guided the research.
...
[Author 1] is an undergraduate researcher in computer vision and applied machine learning. During the SLAT project, [he/she] contributed to system architecture, feature engineering, and performance evaluation. [He/She] is interested in accessibility-focused AI solutions and human-computer interaction.
...
[Author 2] worked on UI/UX design, data collection workflow, and integration testing for the SLAT application. [He/She] has academic interests in software engineering, cross-platform application development, and inclusive technology design.
...
[Author 3] focused on machine learning model development, comparative analysis of Random Forest and MLP, and documentation of experimental results. [He/She] is interested in AI model optimization and assistive communication technologies.
...
The thesis was supervised by [Supervisor Name], who provided guidance on methodology, evaluation design, and academic writing standards throughout the project lifecycle.
...
- Hardware: Built-in or external webcam  
...
2. **MediaPipe import error**  
   - Reinstall MediaPipe inside the active virtual environment:
     ```bash
     pip uninstall mediapipe -y
     pip install mediapipe
     ```

3. **No speech output (Windows/Linux)**  
   - Confirm audio device settings and volume.  
   - Verify `pyttsx3` backend is functional on the host OS.

---

## APPENDIX C: USER MANUAL

### C.1 Training a New Gesture Set

1. Launch the app and open the **Train Model** tab.  
2. Start the camera preview.  
3. Enter a gesture label (e.g., `HELLO`).  
4. Click **Record** and perform the gesture consistently.  
5. Repeat until each label has at least 20 samples.  
6. Choose model type (**Random Forest** recommended for baseline).  
7. Click **Train Model** and wait for evaluation output.

### C.2 Real-Time Detection

1. Open the **Detect Signs** tab.  
2. Start the camera.  
3. Perform trained gestures in front of the camera.  
4. Observe predicted sign and confidence indicator.  
5. Allow stable gestures to be appended to the sentence.

### C.3 Sentence Controls

- **SPACE** gesture inserts a space between words.  
- **DELETE** gesture removes the last token.  
- **Backspace** button removes last character/token.  
- **Clear Sentence** resets the full sentence.  
- **Speak Sentence** outputs audio using TTS.

### C.4 Best Practices for Better Accuracy

- Use consistent lighting and avoid backlight.
- Keep hands centered in frame.
- Maintain a clear and plain background.
- Record each gesture from slight natural variations.
- Avoid visually similar gestures unless enough samples are collected.

---

## APPENDIX D: SAMPLE DATA AND TRAINING OUTPUT

### D.1 Example Gesture Labels

| Label | Samples Collected | Notes |
|------|-------------------|-------|
| HELLO | 60 | Stable one-hand gesture |
| THANK YOU | 55 | Slight finger variation observed |
| YES | 52 | High consistency |
| NO | 50 | Occasional confusion with YES |
| PLEASE | 58 | Two-hand variation for some users |

### D.2 Example Training Configuration
...
### D.3 Example Training Results (Representative)

| Metric | Value |
|-------|-------|
| Cross-validation accuracy (mean) | 95.2% |
| Cross-validation std deviation | 2.1% |
| Test accuracy | 96.7% |
| Macro F1-score | 0.96 |

### D.4 Observed Error Patterns

- Confusion increases between visually close finger configurations.
- Fast hand motion during recording reduces landmark stability.
- Inconsistent hand orientation between training and inference degrades confidence.

---

## APPENDIX E: ETHICAL CONSIDERATIONS AND CONSENT TEMPLATE

### E.1 Ethical Considerations

The SLAT project was developed for educational and assistive communication purposes. Gesture data used for model training may include potentially identifiable motion patterns and should be handled responsibly. The following principles were followed:

1. Participation in data collection is voluntary.
2. Participants may withdraw their data before model finalization.
3. Data is stored locally for academic use only unless explicit permission is granted.
4. No biometric identity inference is intended by the system.

### E.2 Participant Consent Template

**Project Title**: Sign Language AI Translator (SLAT)  
**Institution**: Jahangirnagar University  
**Department**: Computer Science and Engineering

I, ________________________, voluntarily agree to provide hand gesture samples for the SLAT research project. I understand that:

1. My participation is voluntary.
2. I may request removal of my data prior to final report submission.
3. My data will be used strictly for research, model training, and academic demonstration.
4. No personally sensitive information beyond gesture samples will be intentionally collected.
...
## APPENDIX F: PROJECT REPOSITORY SNAPSHOT

```
sign-language-ai-translator-main/
├── main.py
├── config.py
├── requirements.txt
├── THESIS_CONTENT.md
...
This appendix provides a high-level repository structure at the time of thesis submission. Runtime artifacts in `data/` vary depending on training sessions.
